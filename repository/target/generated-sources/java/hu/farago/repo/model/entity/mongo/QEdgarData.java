...
public class QEdgarData extends EntityPathBase<EdgarData> {
    ...
    private static final long serialVersionUID = -1774299836L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEdgarData edgarData = new QEdgarData("edgarData");

    public final hu.farago.repo.model.entity.mongo.embedded.edgar.QEdgarXML edgarXML;
    ...
    public QEdgarData(Class<? extends EdgarData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.edgarXML = inits.isInitialized("edgarXML") ? new hu.farago.repo.model.entity.mongo.embedded.edgar.QEdgarXML(forProperty("edgarXML")) : null;
    }
