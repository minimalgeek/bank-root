...
public class QInsiderDataGroup extends EntityPathBase<InsiderDataGroup> {
    ...
    private static final long serialVersionUID = 1431026326L;
    ...
    public final ListPath<hu.farago.data.model.entity.mongo.embedded.FormData, hu.farago.data.model.entity.mongo.embedded.QFormData> formDataList = this.<hu.farago.data.model.entity.mongo.embedded.FormData, hu.farago.data.model.entity.mongo.embedded.QFormData>createList("formDataList", hu.farago.data.model.entity.mongo.embedded.FormData.class, hu.farago.data.model.entity.mongo.embedded.QFormData.class, PathInits.DIRECT2);
