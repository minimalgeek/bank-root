...
public class QMacroMan extends EntityPathBase<MacroMan> {
    ...
    private static final long serialVersionUID = 1048656357L;
    ...
    public final ListPath<hu.farago.data.model.entity.mongo.embedded.Contributor, hu.farago.data.model.entity.mongo.embedded.QContributor> contributors = this.<hu.farago.data.model.entity.mongo.embedded.Contributor, hu.farago.data.model.entity.mongo.embedded.QContributor>createList("contributors", hu.farago.data.model.entity.mongo.embedded.Contributor.class, hu.farago.data.model.entity.mongo.embedded.QContributor.class, PathInits.DIRECT2);
    ...
    public final hu.farago.data.model.entity.mongo.embedded.QToneWithWords tone;
    ...
    public QMacroMan(Class<? extends MacroMan> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tone = inits.isInitialized("tone") ? new hu.farago.data.model.entity.mongo.embedded.QToneWithWords(forProperty("tone")) : null;
    }
